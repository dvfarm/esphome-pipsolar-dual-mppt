...
class Pipsolar : public uart::UARTDevice, public PollingComponent {
  ...
  PIPSOLAR_SENSOR(pv_input_current, QPIGS, float)
  ...
  PIPSOLAR_SENSOR(pv2_charging_power, QPIGS2, float)
  // QPIRI values
  ...
  PIPSOLAR_SWITCH(charger_source_priority_solar_switch, QPIRI)
 ...
 protected:
  ...
  static const size_t COMMAND_QUEUE_LENGTH = 12;
